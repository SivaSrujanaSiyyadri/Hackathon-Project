...
class CaptureZodiacSignIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        csv_content=requests.get(url).csv_content
        ...
        speak_output = 'I see you born on the {day} of {month} {year}, which means your zodiac sign will be {zodiac}.'.format(month=month,day=day, year=year , zodiac=zodiac)
